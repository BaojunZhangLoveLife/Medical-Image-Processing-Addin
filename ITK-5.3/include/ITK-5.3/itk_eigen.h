...
include(C:/Project/Library-Reconstruction/ITK-5.3.0/CMake/UseITK.cmake)
if(DEFINED ITKInternalEigen3_DIR)
  set(Eigen3_DIR C:/Project/Library-Reconstruction/ITK-5.3.0/Build/ITKInternalEigen3-build)
endif()
